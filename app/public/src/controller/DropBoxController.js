class DropBoxController {
  ...
  connectFireBase() {
    ...
    const firebaseConfig = {
      ...
      databaseURL: "https://dropbox-clone-98da2-default-rtdb.firebaseio.com",
      projectId: "dropbox-clone-98da2",
      storageBucket: "dropbox-clone-98da2.appspot.com",
      messagingSenderId: "651187056775",
      appId: "1:651187056775:web:cfea023a1d762fe56fc822",
      measurementId: "G-HRXPS5S3FH"
    };
  ...
  uploadTask(files) {
    ...
    [...files].forEach(file => {
      ...
      promises.push(this.ajax("/upload", 'POST', formData, () => {
        ...
        this.startUploFadTime = Date.now();
      }));
    });
  ...
  readFiles() {
    ...
    this.getFirebaseRef().on('value', snapshot => {
      ...
      snapshot.forEach(snapshotItem => {
        ...
        this.listFilesEl.appendChild(this.getFilView(data, key))
      })
